              ...
              <div className="newsletter-form-info mt-8">
                <form className="flex pb-5 md:max-w-[550px]">
                    <div class="w-full relative max-lg:flex max-lg:flex-col">
                      <input type="email" id="email" class="focus:outline-none bg-[#fff] text-gray-900 rounded-full block w-full p-4 lg:pe-[180px] max-lg:mb-4" placeholder="Email Address*" required />
                      <button type="submit" className="lg:absolute lg:right-0 lg:top-0 lg:ml-2 rounded-full bg-[#000] text-[#fff] hover:bg-[#F1F8E8] hover:text-[#000] block py-4 px-7 duration-[400ms,700ms]">Subscribe Now</button>
                    </div>
                </form>
              </div>
            </div>

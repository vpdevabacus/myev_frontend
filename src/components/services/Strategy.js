    ...
    return (
        <>
            <div className="py-20 bg-[#F1F8E8] ">
                <div className="container mx-auto px-6 md:px-12 xl:px-32">
                    <div className="xl:mb-2 text-center">
                        <h2 className="text-center text-3xl text-black font-semibold md:text-4xl lg:text-5xl mb-10 md:mb-0">How We Work</h2>

                    </div>
                    <div className="grid gap-12 items-center md:grid-cols-2 xl:gap-2 xl:grid-cols-4 md:-mt-20 xl:mt-0 mb-10">
            ...
            {/* <div className="container  mx-auto py-20 bg-black rounded-tl-full rounded-br-full -mt-24  ">
                <div class="w-10/12 mx-auto flex flex-col lg:flex-row">
                    <div class="w-3/12 flex space-between">
                        <div >
                            <img src={ImageIcons.chargingsession} class="w-20 h-20"></img>
                        </div>
                        <div class="ml-3">
                            <h5 class="text-white text-2xl xl:text-3xl font-semibold">1582+</h5>
                            <p class="text-white font-weight: 500 text-base xl:text-lg">Charging sessions</p>
                        </div>

            ...
            <div className=' container mx-auto '>
                <section className="relative flex items-center w-full">
                    <div className="relative items-center w-full px-5 mx-auto md:px-12 lg:px-2 ">
                        <h2 className="text-center text-2xl text-black font-semibold md:text-4xl lg:text-5xl mb-10 md:mb-0">Why you should choice us ?</h2>
                        <div className='px-12'>
                            <p className="mt-10 text-xl font-normal text-[#000] text-left">
                        ...
                        <div className="relative flex md:flex-col lg:flex-row  m-auto  px-12 w-12/12 justify-between my-10 ">
                            ...
                            <div className="container grid gap-1 py-8  text-lg leading-6 text-gray-800 md:gap-8 md:grid-cols-1 md:mx-auto lg:mx-0 md:w-11/12 lg:w-6/12 ">
                                {items.map((item) => (

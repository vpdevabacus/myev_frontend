            ...
            <div className='fast-slow-charger-info mt-10'>
                {type === 'ac_charger_services' ?
                    <div className="bg-[#F1F8E8]">
                        <div className="xl:p-14 max-xl:p-5">
                            <div className="flex flex-row justify-center mx-auto items-center gap-4 xl:mb-10 max-xl:mb-7">
                                <p className="md:text-xl max-md:text-base font-medium text-[#000] text-center">Fast Charging Setup</p>
                                <div className="mt-1">
                                    <label className="relative inline-flex cursor-pointer items-center">
                                        <input id="switch" type="checkbox" className="peer sr-only " checked={isChecked} onChange={handleToggle} />
                                        <label for="switch" className="hidden"></label>
                                        <div className="peer h-7 w-14 rounded-full border bg-[#CCCCCC] after:absolute after:left-[5px] after:top-1 after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-[#0B7132] peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:ring-green-300 peer-checked:after:left-[10px]"></div>
                                    </label>
                                </div>
                                <p className="md:text-xl max-md:text-base font-medium text-[#000] text-center">Slow Charging Setup</p>
                            </div>

                            {isChecked ?
                                <div className='flex gap-4 max-md:flex-col'>
                                    <div className="md:w-3/5">
                                        <h2 className="font-semibold mb-5">Slow Charging Setup</h2>
                                ...
                                <div className='flex gap-4 max-md:flex-col'>
                                    <div className="md:w-3/5">
                                        <h2 className="font-semibold mb-5">Fast Charging Setup</h2>

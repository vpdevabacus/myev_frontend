...
const Header = () => {
    return (
        <>
            <header className="w-full text-[#fff] bg-white body-font">
                ...
                <div className="container flex flex-col items-start p-6 mx-auto md:flex-row">
                    ...
                    <div className="flex items-center justify-center text-base md:ml-auto md:my-auto">
                        <NavLink to="/" className={(isActive) => isActive ? "text-[#0B7132] mr-10 font-normal text-xl" : "mr-10 font-normal text-xl text-[#000]"}>Home</NavLink>                        <a href="#_" className="mr-10 font-normal text-[#000] text-xl">About Us</a>

        ...
        <div className="py-20 bg-[#F1F8E8]">
            <div className="container mx-auto px-6 md:px-12 xl:px-32">
                <div className="mb-16 text-center">
                    <p className="text-[#0B7132] text-lg font-semibold lg:w-8/12 lg:mx-auto">OUR TEAM MEMBER</p>
                    <h2 className="mb-4 text-center mt-4 text-2xl text-gray-900 font-bold md:text-4xl">Group of Certified & Experienced</h2>
                </div>
            </div>

                    ...
                    <div className=' lg:w-3.5/12 lg:flex shadow-lg  px-8 l pb-8'>
                        ...
                        <div className=' lg:w-6/12'>
                            ...
                            <div className='flex mt-10'>
                                <div>
                                    <img src={ImageIcons.vision} class="sm:w-50 sm:h-50" />
                                </div>
                                <div className="ml-3">
                                    <h5 className="text-[#016C80] text-3xl font-semibold ml-3">Our Vision</h5>
                                    <p className="text-black font-weight: 500 text-lg mt-3 ml-3"> Revolutionizing electric mobility, our vision is to establish a
                            ...
                            <div className='flex mt-10'>
                                <div>
                                    <img src={ImageIcons.mission} className=" sm:w-50 sm:h-50" />
                                </div>
                                <div className="ml-3">
                                    <h5 className="text-[#016C80] text-3xl font-semibold ml-3">Our Mission</h5>
                                    <p className="text-black font-weight: 500 text-lg mt-3 ml-3">To propel the electric vehicle revolution, myEV Point is on a mission to establish a widespread network of cutting-edge charging stations. We are dedicated to advancing clean transportation, reducing carbon footprints, and contributing to a sustainable future by providing accessible and efficient charging solutions for electric vehicles worldwide.</p>
                                </div>
                            </div>
                        </div>
                    </div>

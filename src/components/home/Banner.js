        ...
        <>
            ...
            <section className="relative h-full w-full">
                <div className="bg-cover w-full" style={style}>
                    ...
                    <div
                        className="max-w-lg sm:px-4 py-8 lg:py-20 mx-auto text-left md:max-w-none md:text-center cursor-pointer z-40 md:relative"
                    >
                        <div className='text-center space-x-4'>

                            <button className=" bg-white border border-[#E2E8F0] text-[#0B7132] hover:text-[#fff] text-sm  sm:text-lg font-semibold py-3 px-2 sm:px-4 rounded-lg inline-flex items-center hover:shadow-[inset_13rem_0_0_0] hover:shadow-[#0B7132] duration-[400ms,700ms] transition-[color,box-shadow]">
                                <span>
                            ...
                            <button className=" bg-white border border-[#E2E8F0]  text-[#0B7132] hover:text-[#fff] text-sm sm:text-lg font-semibold py-3 px-2 sm:px-3 rounded-lg inline-flex items-center hover:shadow-[inset_13rem_0_0_0] hover:shadow-[#0B7132] duration-[400ms,700ms] transition-[color,box-shadow]">
                                <span>
